...
import '../idCardEditor/print_settings.dart';
    ...
    return Scaffold(
        ...
        body: Row(
          ...
          children: [
            ...
            if (_selectedIndex == 3) Expanded(child: PrintSettings()),
            if (_selectedIndex == 4) Expanded(child: PrintHomePage())
          ],
        )
        // Padding(
